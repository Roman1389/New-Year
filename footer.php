           ...
           <div class="col-md-12 col-lg-6 mb-4 mb-lg-0">
              ...
              <form id="feedbackForm" method="POST" action="">
                 <div class="mb-3">
                    ...
                    <input type="text" id="phone" name="phone" class="form-control" placeholder="Введите ваш телефон">
                 </div>
                 <div class="mb-3">
           ...
           <div class="col-12 col-lg-3">
              <div class="contact-info">
                 ...
                 <p>
                    ...
                    info@newyearmagic.com
                 </p>
                 <p>
                    <i class="fas fa-map-marker-alt"></i>
                    Ул. Сказочная 1, г. Москва
                 </p>
                 <p>
     ...
     <div class="container-fluid mt-4">
        <div class="row justify-content-center">
           <div class="col-12 text-center">
              ...
              <div>
                 <a href="https://vk.com/yourpage" target="_blank" class="mx-2 text-white"
                    style="text-decoration: none;">
                    <i class="fab fa-vk fa-2x"></i>
                 </a>
                 <a href="https://www.instagram.com/yourpage" target="_blank" class="mx-2 text-white"
                    style="text-decoration: none;">
                    <i class="fab fa-instagram fa-2x"></i>
                 </a>
                 <a href="https://t.me/yourpage" target="_blank" class="mx-2 text-white"
                    style="text-decoration: none;">
                    <i class="fab fa-telegram fa-2x"></i>
                 </a>
                 <a href="https://wa.me/yourphonenumber" target="_blank" class="mx-2 text-white"
                    style="text-decoration: none;">
