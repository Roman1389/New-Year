document.addEventListener("DOMContentLoaded", () => {
	const pricePerPerson = 5000 // Фиксированная цена
	const peopleCountInput = document.getElementById("peopleCountOffice")
	const totalPriceInput = document.getElementById("totalPriceOffice")
	const minusButton = document.getElementById("minusButtonOffice")
	const plusButton = document.getElementById("plusButtonOffice")
	const dateInput = document.getElementById("dateOffice")
	const timeSelect = document.getElementById("timeOffice")
	const serviceId = document.querySelector("input[name='service_id']").value
	const userId = document.getElementById("userId7").value
	const form = document.getElementById("officeGreetingForm")
	const timeMessage = document.getElementById("timeMessageOffice")
	let maxSeats = 30

	$(document).ready(function () {
		$("#phoneOffice").inputmask({
	...
	function updateAvailableTimes() {
		...
		fetch("backend/services/office.php", {
			method: "POST",
			headers: {
