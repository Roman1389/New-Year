document.addEventListener("DOMContentLoaded", () => {
	...
	const peopleCountInput = document.getElementById("peopleCountSurprise")
	const totalPriceInput = document.getElementById("totalPriceSurprise")
	const minusButton = document.getElementById("minusButtonSurprise")
	const plusButton = document.getElementById("plusButtonSurprise")
	const dateInput = document.getElementById("dateSurprise")
	const timeSelect = document.getElementById("timeSurprise")
	const serviceId = document.querySelector("input[name='service_id']").value
	const userId = document.getElementById("surpriseUserId").value
	const form = document.getElementById("surpriseForm")
	const timeMessage = document.getElementById("timeMessageSurprise")
	const maxSeats = 30

	$(document).ready(function () {
		$("#phoneSurprise").inputmask({
	...
	function updateAvailableTimes() {
		...
		fetch("backend/services/surprise.php", {
			method: "POST",
			headers: {
