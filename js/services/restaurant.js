document.addEventListener("DOMContentLoaded", () => {
	...
	const peopleCountInput = document.getElementById("peopleCountRestaurant")
	const totalPriceInput = document.getElementById("totalPriceRestaurant")
	const minusButton = document.getElementById("minusButtonRestaurant")
	const plusButton = document.getElementById("plusButtonRestaurant")
	const dateInput = document.getElementById("dateRestaurant")
	const timeSelect = document.getElementById("timeRestaurant")
	const serviceId = document.querySelector("input[name='service_id']").value
	const userId = document.getElementById("userId8").value
	const form = document.getElementById("restaurantServiceForm")
	const timeMessage = document.getElementById("timeMessageRestaurant")
	let maxSeats = 30

	$(document).ready(function () {
		$("#phoneRestaurant").inputmask({
	...
	function updateAvailableTimes() {
		...
		fetch("backend/services/restaurant.php", {
			method: "POST",
			headers: {
