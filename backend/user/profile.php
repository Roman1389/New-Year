...
foreach ($categoriesArray as $categoryId => $categoryName) {
    ...
    $countQuery = "SELECT COUNT(*) AS total FROM orders 
                    ...
                    WHERE services.category_id = $categoryId AND orders.user_id = $userId";
    ...
    WHERE orders.user_id = $userId AND services.category_id = $categoryId
...
include '../../layouts/user/profile.php';
