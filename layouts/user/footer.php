...
<footer id="contacts" class="bg-dark text-light py-4 mt-5">
   <div class="container-fluid px-5 mt-4">
      <!-- Первая строка с О компании -->
      <div class="row justify-content-center">
         <!-- О компании -->
         <div class="col-12 col-lg-12 text-start mb-4 mb-lg-0">
      ...
      <!-- Третья строка с Контактами -->
      <div class="row justify-content-center">
         <div class="col-12 col-lg-3 text-center">
            <h5 class="text-navigation mb-3">Контакты</h5>
            <p><i class="fas fa-phone-alt"></i> +7(999) 123-45-67</p>
            <p><i class="fas fa-envelope"></i> info@newyearmagic.com</p>
            <p><i class="fas fa-map-marker-alt"></i> Ул. Сказочная 1, г. Москва</p>
            <p><i class="fas fa-clock"></i> Ежедневно: 09:00-21:00</p>
         </div>
      </div>
   </div>
